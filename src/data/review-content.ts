...
export const bodyBlocks: Block[] = [
  {
    type: "lead",
    lines: [
      ["이 글은 내막증 치료 후에 또 발견한 자궁근종을 극복하고,"],
      ["마침내 소중한 아이까지 갖게 된 저의 처절한 기록입니다."],
    ],
  },
  {
    type: "quote",
    lines: [[b("“이번엔 자궁근종이 생겼네요. 크기도 5cm입니다.”")]],
  },
  {
    type: "lines",
    lines: [
  ...
  },
  {
    type: "lines",
    lines: [
      ["혹시나 해서 산부인과에 가보니, 자궁내막증이라는"],
      ["이름도 어려운 병이더라고요."],
      ["임신을 계획하던 중이기에 더 마음이 복잡했습니다."],
    ],
  },
  {
    type: "image",
  ...
  },
  {
    ...
    lines: [
      ...
      ["한의원을 비롯해, 여성에게 좋다는 테라피에도 수 백 만원…"],
    ],
  },
  {
    type: "lines",
    lines: [
      ["나름 관리하며 지내와서,"],
      ["완전히 끝난 줄 알았던 병이었습니다."],
      ["어느 날부터 다시 시작된 생리통, 허리통증, 부정출혈…"],
      ["혹시나 했던 불안은"],
      ["초음파실 검사실에서 절망으로 바뀌었습니다."],
    ],
  },
  {
    type: "image",
  ...
  {
    type: "quote",
    lines: [[b("\"수술을 하기엔 부담스러우니 일단 경과를 지켜봅시다.\"")]],
  },
  {
    type: "quote",
    lines: [
  ...
  },
  {
    ...
    lines: [
      ["'지켜보자'는 말이 얼마나 무서운지"],
      ["경험해 본 분들은 아실 겁니다."],
      ["아무것도 하지 않고 혹이 더 커지기를 기다리는 것만 같아"],
      ["매일 밤 잠을 이룰 수 없었어요."],
    ],
  },
  {
    type: "lines",
    lines: [
      ["이제사 임신에 대한 희망을 다시 품을 수 있었는데 적출이라니…"],
  ...
  },
  {
    ...
    lines: [
      ["하지만 결과는 참담했습니다."],
      ["오히려 온열 자극 때문에 골반 쪽 혈류가 과하게 쏠리면서"],
      ["부정출혈이 더 심해졌고,"],
      ["생리 주기도 완전히 뒤엉켜 버렸습니다."],
    ],
  },
  { type: "divider" },
  ...
  },
  {
    ...
    lines: [
      ...
      ["바로 '과잉 에스트로겐 축적 (에스트로겐 우세증)'이었습니다."],
    ],
  },
  {
    type: "lines",
  ...
  },
  {
    ...
    lines: [
      ...
      ["배를 따뜻하게 하는 것만으로는"],
      ["자궁 속 깊이 쌓인 '에스트로겐 독소'를 없앨 수 없었던 것입니다."],
    ],
  },
  ...
  { type: "h3", text: ["① 규칙적인 골반 순환 운동"] },
  {
    type: "lines",
    lines: [
      ["하루 20~30분 가볍게 걷기, 고관절 스트레칭을 통해"],
      ["골반 내부의 혈액순환을 돕고 면역력을 끌어올리려 노력했어요."],
      ["활발한 혈액 순환으로, 독소를 조금이라도 빼기 위해서요."],
    ],
  },
  ...
  },
  {
    ...
    lines: [
      ["해외 수십 편의 논문을 조사한 결과,"],
      [b("십자화과 채소(브로콜리새싹, 양배추, 케일 등) 추출 성분과")],
      [b("강황 유래 항산화 복합물"), "이 간의 에스트로겐 대사를 도와"],
      [r("과잉 에스트로겐을 분해"), "하고"],
      [r("자궁 독소를 배출"), "하는 데 결정적인 역할을 한다는 것을 알게 되었어요."],
    ],
  },
  {
    type: "image",
  ...
  },
  {
    type: "lines",
    lines: [
      ["자료를 서치하고 결론을 도출하는데 수 개월이 걸렸지만,"],
      ["자궁 내막증을 어떻게 예방하고 관리하는지 찾아냈다는게"],
      ["정말 뿌듯하고, 또 안심이 되었어요."],
    ],
  },
  { type: "h2", text: ["3. 마침내 찾아낸 자궁 디톡스 솔루션"] },
  {
    type: "lines",
    lines: [
      ["처음에는 강황, 브로콜리 새싹, 양배추, 케일, 강황, 녹차 등을"],
      ["직접 챙겨 먹으려 했으나,"],
  ...
  { type: "lines", lines: [["복용 후 변화는 생각보다 빠르게 찾아왔습니다."]] },
  { type: "h3", text: [r("1개월 차")] },
  {
    type: "lines",
    lines: [
      ["매달 삶을 흔들던 극심한 생리통과"],
      ["생리 전 부정출혈이 눈에 띄게 줄어들었습니다."],
    ],
  },
